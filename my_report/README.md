...
![Screenshot (247)](https://user-images.githubusercontent.com/101416820/232731520-97313396-4559-4930-aa9b-fcf8310691bd.png)
 ...
 ![Screenshot (247)](https://user-images.githubusercontent.com/101416820/232732756-f05c68b2-c274-45e2-ac21-8047bbee0081.png)
...
Επιπλέον άλλαξα  τα φώτα των κτηρίων ωστέ να είναι πιο θερμά και το πράσινο φως της πόρτα στο στενό το έκανα να τρεμοπαίζει όπως και το φώς στην ταράτσα του αριστερού γωνιακού κτηρίου. Μείωσα το focal length των δύο πρώτων virtual καμερών και πρόσθεσα ακόμη μια για το τελευτέο πλάνο του animation που δείχνει την πόλη με focal length 8 για να φαίνεται σαν ευρωγώνια η λήψη. Έκανα την ομίχλη λιγότερο έντονη και με διαφορετικό χρώμα, συγκεκριμένα έδωσα σκούρο γκρι χρώμα. Άλλαξα τις τιμές για το Bloom effect συσκεκριμένα για το threshold 1.25, το intensity 0.03 και το scatter 0.85. Όρισα το Lift Gamma Gain και το White Balance όπως τις οδηγίες και μετέβαλα το Motion blur δίνοντας για το intensity την τιμή 0.1. Επιπλέον δεν χρησιμοποίησα το Shadows Midtones Highlights. Στο vignette έδωσα 0.24 στο intensity και 0.1 στο smoothness και για το depth of field όρισα το mode ως bokeh, focus distance 3, focal lenght 17 και aperture 32. Τέλος πρόσθεσα 2 έτοιμα props το ένα είνα το ταξί και το άλλο το skateboard στην αρχή του στενού.
