...
# Conclusions
Τα συνολικά συμπεράσματα από όλα τα παραδοτέα είναι ότι όσο περισσότερη ήταν η ενασχόληση τόσο πιο εύκολα και χωρίς προβλήματα γινόταν η υλοποίηση. Το τελευταίο παραδοτέο ήταν το πιο απαιτητικό καθώς το ξεκίνησα από την αρχη. Σε κάθε παραδοτέο ήταν ιδιαίτερα χρήσιμες οι οδηγίες για το κάθε unit τις οποίες και ακολούθησα και κάποια tutorials που χρησιμοποίησα γενικα στα παραδοτέα και υπάρχουν παρακάτω στις πηγές.
