...
Unit 7: Αρχικά επεξεργάστηκα όλα τα φώτα της ετοιμης σκηνής και δημιουργησα νέα sparks και καπνό για την περιοχή των κάδων (εικόνες α, β). Έπειτα δημιούργησα διαφορετικό καπνό για την αρχή του στενού στο οποίο ξεκινά το κυνήγι (εικόνα γ). Το κυνήγι ξεκινά την ώρα που ψυχαλίζει και έτσι πέρα από τους ήχους της γάτας και τού σκύλου χρησιμοποίησα και ήχο βροχής για το εφέ αυτό που δημιούργησα (εικόνα δ).

εικόνα α)  ![Screenshot (238)](https://user-images.githubusercontent.com/101416820/232632076-487a6150-504d-4adb-9429-eb036ebbd84e.png)

εικόνα β)  ![Screenshot (239)](https://user-images.githubusercontent.com/101416820/232632116-a0511fd5-83d3-445d-be25-f9c66df343b5.png)

εικόνα γ)  ![Screenshot (241)](https://user-images.githubusercontent.com/101416820/232632183-92550ded-1f05-4edc-98bd-17d015af98e4.png)

εικόνα δ)  ![Screenshot (237)](https://user-images.githubusercontent.com/101416820/232632222-a391634e-f1e3-49c0-ad01-e6c94b4aae63.png)
